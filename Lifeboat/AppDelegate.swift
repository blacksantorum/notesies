...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        var keychain = KeychainItemWrapper(identifier: keyKey, accessGroup: nil)
        key = keychain.objectForKey(kSecAttrAccount) as? String
        
        println("Key in App delegate: \(key)")
        println("Key length in App Delegate: \(key?.isEmpty)")
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        if let nav = self.window!.rootViewController as? UINavigationController {
            ...
            nav.dismissViewControllerAnimated(false, completion: { () -> Void in
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.blacksantorum.Lifeboat" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Lifeboat", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Lifeboat.sqlite")
